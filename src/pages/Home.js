...
import { Block, Button, Input, ItemList, CommentsList, Textarea } from '../components'
import { addItem, getItem, setActiveItem } from '../redux/actions/items'
import { addComment, setCommentsItem, setCommentsCount, getComments, getCommentsItem } from '../redux/actions/comments'
const Home = () => {
  ...
  return (
    <div className="container">
      ...
      <Block className={'small'}>
        <>
          {comments.length === 0 && <h2>No any Comments</h2>}
          {comments.length !== 0 &&
            <>
